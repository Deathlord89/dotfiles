...
let
  cfg = config.optional.syncthing;
in
{
  options.optional.syncthing = {
    enable = lib.mkEnableOption "Enable Syncthinc Service";
  };
      ...
      syncthing = {
        ...
        settings = {
          devices = {
            ...
            iPhone.id = "7C5QRXP-TJK4DL7-U4PFMAV-4UNLA6J-JJJ7ZDH-QDARARR-TCMMTEU-TPQ4RQQ";
